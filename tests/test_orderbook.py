...
def test_orderbook_fifo_priority_and_depth():
    ...
    o1 = Order(order_id="B1", client_order_id="CB1", symbol="BTC-USD", side=Side.BUY, order_type=OrderType.LIMIT, price=100.0, quantity=5.0, timestamp=1.0)
    o2 = Order(order_id="B2", client_order_id="CB2", symbol="BTC-USD", side=Side.BUY, order_type=OrderType.LIMIT, price=100.0, quantity=3.0, timestamp=2.0)
    ...
    # Insert asks
    a1 = Order(order_id="A1", client_order_id="CA1", symbol="BTC-USD", side=Side.SELL, order_type=OrderType.LIMIT, price=101.0, quantity=4.0, timestamp=1.5)
...
def test_orderbook_snapshot():
    ...
    book.insert_order(Order(order_id="E1", client_order_id="C1", symbol="ETH-USD", side=Side.BUY, order_type=OrderType.LIMIT, price=2000.0, quantity=10.0))
    book.insert_order(Order(order_id="E2", client_order_id="C2", symbol="ETH-USD", side=Side.SELL, order_type=OrderType.LIMIT, price=2010.0, quantity=5.0))
