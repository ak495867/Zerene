...
class TickDataLoader:
    ...
    """
    @staticmethod
    def from_csv_file(filepath: str, symbol: str = "BTC-USD") -> Generator[Order, None, None]:
        """
        ...
        with open(filepath, mode="r", encoding="utf-8") as f:
            ...
            for idx, row in enumerate(reader):
                ...
                otype = OrderType[otype_str] if otype_str in OrderType.__members__ else OrderType.LIMIT
    ...
    @staticmethod
    def from_dicts(records: List[Dict[str, Any]], symbol: str = "BTC-USD") -> Generator[Order, None, None]:
    ...
    @staticmethod
    def from_parquet_file(filepath: str, symbol: str = "BTC-USD") -> Generator[Order, None, None]:
        """
        ...
        try:
            ...
            raise ImportError("pyarrow is required to read Parquet Level III files (`pip install pyarrow`).")
